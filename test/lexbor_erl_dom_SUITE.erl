...
-export([test_get_attribute/1, test_set_attribute/1, test_remove_attribute/1,
         test_attribute_not_found/1, test_get_text/1, test_set_text/1, test_inner_html/1,
         test_set_inner_html/1, test_serialize/1, test_create_element/1, test_append_child/1,
         test_insert_before/1, test_remove_node/1, test_complex_dom_building/1]).
